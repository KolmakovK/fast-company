...
const UserPage = () => {
  ...
  useEffect(() => {
    Api.users.fetchAll().then((p) => setUsers(p))
  }, [])

  useEffect(() => {
    Api.users.getById(userId).then((data) => setUser(data))
  }, [])
  const userSelect = users.map((option) => (
                ...
                <div className="card-body">
                  <div>
                    ...
                    <div className="mb-4">
                      ...
                      {/* Вот этот компонент снизу у меня уже давно. Пробовал но не закончил пока не понятно можно ли его сюда воткнуть чтоб его менять не пришлось */}
                      <SelectField
                        name="userId"
